...
namespace MonoSecurity.Drawing
{
    ...
    public static class Circle
    {
        ...
        public static void DrawCircleMain(Vector2 center, float radius, Color color, float width, bool antiAlias, int segmentsPerQuarter)
        {
            DrawCircle(center, radius, color, width, antiAlias, segmentsPerQuarter);
        }

        public static void DrawCircle(Vector2 center, float radius, Color color, float width, bool antiAlias, int segmentsPerQuarter)
        {
            float rh = radius * 0.551915024494f; //Gives better result compared to original 
        ...
        */
        private static void Initialize(Color color)
        {
            ...
            if (aaLineTex == null)
            {
                ...
                aaLineTex.SetPixel(0, 1, Color.cyan);
